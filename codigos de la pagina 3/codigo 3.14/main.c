...
void main(void)
{
    ...
    while (VOT) // Continúa hasta que se ingrese un voto igual a 0
    {
        switch (VOT) // Evalúa el voto recibido
        {
        case 1:
            C1++;
            break;
        ...
        case 5:
            ...
            break;
        default:
            NU++; // Incrementa los votos nulos si el voto no corresponde a ningún candidato
            break;
        }
    ...
    printf("\nTotal de votos: %d\n", SVO);
    printf("\nCandidato 1: %d votos -- Porcentaje: %5.2f%%\n", C1, PO1);
